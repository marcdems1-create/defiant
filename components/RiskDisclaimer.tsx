  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-ink/65 leading-relaxed">
        ...
        guaranteed. You can lose capital to market, liquidity, or smart-contract failure. Defiant
  ...
  return (
    <footer className="border-t border-border mt-16 mb-4 md:mb-0">
      <div className="max-w-6xl mx-auto px-6 py-6 text-[11px] leading-relaxed text-ink/40">
        Defiant is a non-custodial interface. Yield is not a deposit, is not insured, and is not
